  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-[#faf8f2]">
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-bold text-ink-900 mb-6 text-center">Log in</h1>
        ...
        <p className="mt-4 text-center text-ink-600 text-sm">
          No account? <Link href="/register" className="text-sage-600 hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
